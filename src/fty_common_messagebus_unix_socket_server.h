...
#ifndef FTY_COMMON_MESSAGEBUS_UNIX_SOCKET_SERVER_H_INCLUDED
#define FTY_COMMON_MESSAGEBUS_UNIX_SOCKET_SERVER_H_INCLUDED
...
namespace messagebus
{
    ...
    class MessageBusUnixSocketServer : public MessageBus
    {
      public:
        /**
         ...
         * @param maxClient: Maximum number of client for the server. If 0, the MessageBusUnixSocketServer object is consider as a client.
         */
        explicit MessageBusUnixSocketServer(const std::string& socketPath, const std::string& serverName, size_t maxClient = 32);
        ~MessageBusUnixSocketServer();
