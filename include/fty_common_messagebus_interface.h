...
namespace messagebus {
    ...
    class MessageBus {
      public:
        ...
        /**
         * @brief Unreceive message from queue
         *
         * @param queue             The queue to unreceive
         * @param messageListener   The message listener to remove from queue
         *
         * @throw MessageBusException any exceptions
         */
        virtual void unreceive(const std::string& queue, MessageListener messageListener) = 0;
